...
<h3>Обо мне</h3>
🔭 На данный момент я работаю над системой удалённого управления котлами отопления на базе контроллера Biomatic.
🌱 Изучаю TypeScript.
🤝 Ищу работу frontend, backand либо fullstack-разработчиком.
